 ...
 */
export function disableTransactionButtons() {
    // Trading buttons
    ...
    dom.unwrapMaxBtn.disabled = true;
    ...
    const buttons = [dom.depositLongBtn, dom.withdrawLongBtn, dom.depositShortBtn, dom.withdrawShortBtn,
        dom.faucetBtn, dom.wrapCsprBtn, dom.unwrapCsprBtn, dom.unwrapMaxBtn, dom.approveMarketBtn];
    buttons.forEach(btn => {
 ...
 */
export function enableTransactionButtons() {
    // Trading buttons
    ...
    dom.unwrapMaxBtn.disabled = false;
 ...
 */
export function showTransactionPopup(description) {
 ...
 */
export function showTransactionHashInProgress(hash) {
 ...
 */
export function onTransactionTimeout() {
