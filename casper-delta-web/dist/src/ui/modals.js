 ...
 */
export function showErrorWithTransaction(msg, hash) {
    if (dom.errorModalMessage && dom.errorModalOverlay) {
 ...
 */
export function showTransaction(hash) {
 ...
 */
export function initializeTradingInfo() {
 ...
 */
export function closeTradingInfo() {
 ...
 */
export function showTradingInfo() {
