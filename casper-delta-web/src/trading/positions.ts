...
import {
    consolidatedData,
    setCurrentLongClosePercentage,
    setCurrentShortClosePercentage,
    setCurrentLongCloseAmount,
    setCurrentShortCloseAmount,
 ...
 */
export function updateLongCloseAmount(percentage: number): void {
 ...
 */
export function updateShortCloseAmount(percentage: number): void {
    if (!consolidatedData || !consolidatedData.addressMarketState) return;
 ...
 */
function updateLongCloseButtons(activePercentage: number): void {
 ...
 */
function updateShortCloseButtons(activePercentage: number): void {
 ...
 */
export function resetLongCloseAmount(): void {
 ...
 */
export function resetShortCloseAmount(): void {
 ...
 */
export function handleLongCloseManualInput(): void {
    if (!consolidatedData || !consolidatedData.addressMarketState) return;
 ...
 */
export function handleShortCloseManualInput(): void {
    if (!consolidatedData || !consolidatedData.addressMarketState) return;
 ...
 */
export function updateCloseButtonsAvailability(): void {
    if (!consolidatedData || !consolidatedData.addressMarketState) return;
...
function showTokenAmount(el: HTMLDivElement, tokenAmount: U256, label: string): void {
    el.textContent = `≈ ${formatNumber(tokenAmount)} ${label} tokens`;
    el.classList.remove("hidden");
}

function hideTokenAmount(el: HTMLDivElement): void {
    el.textContent = "";
