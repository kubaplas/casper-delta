import { TransactionResult } from "casper-delta-wasm-client";
 ...
 */
export async function onTransactionSuccessFromCsprClick(data: TransactionResult): Promise<void> {
 ...
 */
export function onTransactionExpired(): void {
 ...
 */
export function onTransactionCancelled(): void {
