...
/**
 * @enum {60003 | 60002 | 60001}
 */
export const WrappedNativeTokenErrors = Object.freeze({
    /**
     * The user cannot target themselves.
     */
    CannotTargetSelfUser: 60003, "60003": "CannotTargetSelfUser",
...
export class Address {
    ...
    get value() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.address_value(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
...
export class ContractInfo {
    ...
    get address() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.contractinfo_address(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
...
const DepositFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_deposit_free(ptr >>> 0, 1));
...
export class Deposit {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        DepositFinalization.unregister(this);
        return ptr;
    }
    ...
    constructor(account, value) {
        try {
            ...
            this.__wbg_ptr = r0 >>> 0;
            DepositFinalization.register(this, this.__wbg_ptr, this);
            return this;
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
...
export class MarketWasmClient {
     ...
     */
    contractIconUri() {
        const ret = wasm.marketwasmclient_contractIconUri(this.__wbg_ptr);
        return takeObject(ret);
    }
    /**
...
export class PublicKey {
    ...
    toJson() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.publickey_toJson(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
...
export class SignResult {
    ...
    get signatureHex() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_signresult_signatureHex(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            let v1;
            if (r0 !== 0) {
...
export class TransactionData {
    ...
    get transactionHash() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_transactiondata_transactionHash(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
...
export class TransactionResult {
    ...
    get txHash() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.transactionresult_txHash(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            let v1;
            if (r0 !== 0) {
...
export class U128 {
    ...
    get value() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.u128_value(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
...
export class U256 {
    ...
    get value() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.u256_value(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
...
export class U512 {
    ...
    get value() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.u512_value(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
...
const WithdrawalFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_withdrawal_free(ptr >>> 0, 1));
...
export class Withdrawal {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WithdrawalFinalization.unregister(this);
        return ptr;
    }
    ...
    constructor(account, value) {
        try {
            ...
            this.__wbg_ptr = r0 >>> 0;
            WithdrawalFinalization.register(this, this.__wbg_ptr, this);
            return this;
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
...
const WrappedNativeTokenWasmClientFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wrappednativetokenwasmclient_free(ptr >>> 0, 1));
...
export class WrappedNativeTokenWasmClient {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WrappedNativeTokenWasmClientFinalization.unregister(this);
        return ptr;
    }
    ...
    withdrawTo(recipient, amount) {
        ...
        _assertClass(amount, U256);
        var ptr1 = amount.__destroy_into_raw();
        const ret = wasm.wrappednativetokenwasmclient_withdrawTo(this.__wbg_ptr, ptr0, ptr1);
        return takeObject(ret);
    }
    /**
     * Returns the total supply of the token.
    ...
    transferFrom(owner, recipient, amount) {
        ...
        _assertClass(amount, U256);
        var ptr2 = amount.__destroy_into_raw();
        const ret = wasm.wrappednativetokenwasmclient_transferFrom(this.__wbg_ptr, ptr0, ptr1, ptr2);
        return takeObject(ret);
    }
    /**
     * Returns the name of the token.
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_connect_4b4ca5f12ab32dae = function() { return handleError(function (arg0, arg1) {
    ...
    imports.wbg.__wbg_disconnect_cb64efc224949ec3 = function() { return handleError(function () {
    ...
    imports.wbg.__wbg_getActiveAccountAsync_88a49641592ee985 = function() { return handleError(function (arg0) {
        const ret = window.csprclick.getActiveAccountAsync(getObject(arg0));
        return addHeapObject(ret);
    }, arguments) };
    imports.wbg.__wbg_getActivePublicKey_62936859325e00eb = function() { return handleError(function () {
    ...
    imports.wbg.__wbg_isUnlocked_a3fc4e36e2d07d00 = function() { return handleError(function (arg0, arg1) {
    ...
    imports.wbg.__wbg_log_5dd5630ab2c63ebc = function(arg0, arg1) {
    ...
    imports.wbg.__wbg_on_899c63295dd05aa5 = function() { return handleError(function (arg0, arg1, arg2) {
    ...
    imports.wbg.__wbg_send_98ebbcd5cf3de23f = function() { return handleError(function (arg0, arg1, arg2, arg3, arg4) {
    ...
    imports.wbg.__wbg_signInWithAccount_f916483f9fb67af2 = function() { return handleError(function (arg0) {
        const ret = window.csprclick.signInWithAccount(AccountInfo.__wrap(arg0));
        return addHeapObject(ret);
    }, arguments) };
    imports.wbg.__wbg_signIn_6b5067c86d553a15 = function() { return handleError(function () {
        window.csprclick.signIn();
    }, arguments) };
    imports.wbg.__wbg_signMessage_765bdba12afc4182 = function() { return handleError(function (arg0, arg1, arg2, arg3) {
        const ret = window.csprclick.signMessage(getStringFromWasm0(arg0, arg1), getStringFromWasm0(arg2, arg3));
        return addHeapObject(ret);
    }, arguments) };
    imports.wbg.__wbg_signOut_1cb8dbfb1401b84d = function() { return handleError(function () {
    ...
    imports.wbg.__wbg_switchAccount_882c812d7b7618fc = function() { return handleError(function () {
    ...
    imports.wbg.__wbindgen_closure_wrapper4769 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 691, __wbg_adapter_44);
        return addHeapObject(ret);
    };
