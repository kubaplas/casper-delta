Feature: Casper Shorts MarketContract tests
    ...
    Scenario: Going short when liquidity is zero
        When Alice goes long with 300 WCSPR
        And Bob goes short with 300 WCSPR
        And price changes to 0.03 USD
        And price changes to 100 USD
        When Alice goes short with 100 WCSPR

    Scenario: Goin long when liquidity is zero 
        When price changes to 100 USD
        When Alice goes short with 300 WCSPR
        And Bob goes long with 300 WCSPR
        And price changes to 0.03 USD
        When Alice goes long with 100 WCSPR